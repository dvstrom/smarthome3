...
public class DeviceActivity  extends FragmentActivity {
	...
	private DeviceImageAdapter adapter=null;
	...
	private void initRes(){
		...
		adapter = new DeviceImageAdapter(this); 	
		...
		gallery.setOnItemClickListener(new OnItemClickListener() {			// 设置点击事件监听
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				Toast.makeText(DeviceActivity.this, "img " + (position+1) + " selected", Toast.LENGTH_SHORT).show();
			}
		});
	}
	...
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			Toast.makeText(DeviceActivity.this,"这是第" + index+ "张图片",3).show();
